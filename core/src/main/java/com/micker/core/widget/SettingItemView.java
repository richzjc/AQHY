...
public class SettingItemView extends RelativeLayout {
    ...
    protected int getLayoutId() {
        return R.layout.base_set_item_view;
    }
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        checkbox.addSwitchObserver(new RMSwitch.RMSwitchObserver() {
            @Override
    ...
    private SettingItemView.OnCheckedChangeListener listener;

    public void setCheckChangListener(SettingItemView.OnCheckedChangeListener listener) {
